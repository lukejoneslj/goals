...
export default function GoalsGuide() {
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="flex justify-between items-center py-2 sm:py-3 md:py-4">
            ...
            <div className="hidden md:flex items-center space-x-6">
              <Link href="/goals-guide" className="text-muted-foreground hover:text-foreground font-medium transition-colors text-sm">
                Goals Guide
              </Link>
            </div>
            <div className="flex items-center space-x-2 sm:space-x-3 md:space-x-4 flex-shrink-0">
              ...
              <Button asChild size="sm" className="bg-primary text-primary-foreground hover:opacity-90 text-xs sm:text-sm px-2 sm:px-3 md:px-4">
      ...
      {/* Hero Section */}
      <section className="pt-12 sm:pt-16 md:pt-20 pb-12 sm:pb-14 md:pb-16 bg-gradient-to-br from-secondary/20 to-background">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <div className="flex justify-center mb-4 sm:mb-6 md:mb-8">
              <Badge className="bg-primary/10 text-primary px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium border border-primary/20">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-4 sm:mb-6 md:mb-8 px-2 tracking-tight">
              Master Your Goals,
              <br />
      ...
      <section className="py-8 sm:py-12 md:py-16 bg-background">
        <div className="max-w-4xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="bg-destructive/10 rounded-2xl p-4 sm:p-6 md:p-8 border-l-4 border-destructive mb-8 sm:mb-12 md:mb-16">
            <div className="flex items-start space-x-3 sm:space-x-4">
              <AlertTriangle className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-destructive mt-1 flex-shrink-0" />
              <div>
                <h2 className="text-xl sm:text-2xl font-bold text-foreground mb-3 sm:mb-4">Let's Be Brutally Honest</h2>
      ...
      {/* Seven Steps Section */}
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-secondary/20 to-background">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12 md:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mb-4 sm:mb-6 px-2 tracking-tight">
          ...
          <div className="space-y-4 sm:space-y-6 md:space-y-8">
            {/* Step 1 */}
            <Card className="overflow-hidden border border-border bg-card shadow-md hover:shadow-lg transition-all">
              <div className="bg-gradient-to-r from-blue-400 to-blue-500 text-white p-4 sm:p-5 md:p-6">
                <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-3 md:space-x-4">
                  <Badge className="bg-white text-blue-500 text-sm sm:text-base md:text-lg font-bold px-2 sm:px-3 md:px-4 py-1 sm:py-1.5 md:py-2 w-fit">1</Badge>
              ...
              <CardContent className="p-4 sm:p-6 md:p-8">
                <div className="grid md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 items-center">
                  <div>
                    ...
                    <div className="bg-blue-50/50 p-4 rounded-lg border-l-4 border-blue-300">
                      <p className="text-sm font-semibold text-blue-700">Pro Tip:</p>
                      <p className="text-sm text-blue-600">Use numbers, dates, and concrete descriptions. If you can't measure it, you can't manage it.</p>
                    </div>
                  </div>
                  <div className="bg-blue-50/30 p-6 rounded-xl border border-blue-200/50">
                    <h4 className="font-bold text-foreground mb-4">❌ Vague vs ✅ Specific</h4>
                    <div className="space-y-3 text-sm">
                      <div className="flex items-center space-x-3">
                        <XCircle className="w-4 h-4 text-destructive" />
                        <span className="line-through text-muted-foreground">"Get in shape"</span>
                      </div>
                      <div className="flex items-center space-x-3">
                        <CheckCircle2 className="w-4 h-4 text-emerald-500" />
                        <span className="text-foreground">"Lose 20 pounds and deadlift 200 lbs by June 1st"</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {/* Step 2 */}
            <Card className="overflow-hidden border border-border bg-card shadow-md hover:shadow-lg transition-all">
              <div className="bg-gradient-to-r from-emerald-400 to-emerald-500 text-white p-6">
                <div className="flex items-center space-x-4">
                  <Badge className="bg-white text-emerald-500 text-lg font-bold px-4 py-2">2</Badge>
              ...
              <CardContent className="p-8">
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div>
                    ...
                    <div className="bg-emerald-50/50 p-4 rounded-lg border-l-4 border-emerald-300">
                      <p className="text-sm font-semibold text-emerald-700">Reality Check:</p>
                      <p className="text-sm text-emerald-600">Add 25% more time than you think you need. Life will throw curveballs.</p>
                    </div>
                  </div>
                  <div className="bg-emerald-50/30 p-6 rounded-xl border border-emerald-200/50">
                    <Calendar className="w-16 h-16 text-emerald-500 mx-auto mb-4" />
                    <div className="text-center">
                      <p className="text-2xl font-bold text-foreground mb-2">June 1, 2024</p>
                      <p className="text-sm text-muted-foreground">Not "this summer" or "eventually"—a real date that you write in your calendar</p>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="overflow-hidden border border-border bg-card shadow-md hover:shadow-lg transition-all">
              <div className="bg-gradient-to-r from-rose-400 to-rose-500 text-white p-6">
                <div className="flex items-center space-x-4">
                  <Badge className="bg-white text-rose-500 text-lg font-bold px-4 py-2">3</Badge>
              ...
              <CardContent className="p-8">
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div>
                    ...
                    <div className="bg-rose-50/50 p-4 rounded-lg border-l-4 border-rose-300">
                      <p className="text-sm font-semibold text-rose-700">Hard Truth:</p>
                      <p className="text-sm text-rose-600">Your biggest obstacle is usually yourself—your habits, fears, and excuses.</p>
                    </div>
                  </div>
                  <div className="bg-rose-50/30 p-6 rounded-xl border border-rose-200/50">
                    <h4 className="font-bold text-foreground mb-4">Common Goal Killers:</h4>
                    <div className="space-y-2 text-sm">
                      <div className="flex items-center space-x-3">
                        <Clock className="w-4 h-4 text-rose-500" />
                        <span className="text-foreground">"I don't have time"</span>
                      </div>
                      <div className="flex items-center space-x-3">
                        <Coffee className="w-4 h-4 text-rose-500" />
                        <span className="text-foreground">"I'm too tired after work"</span>
                      </div>
                      <div className="flex items-center space-x-3">
                        <Users className="w-4 h-4 text-rose-500" />
                        <span className="text-foreground">"My family doesn't support this"</span>
                      </div>
                      <div className="flex items-center space-x-3">
                        <Brain className="w-4 h-4 text-rose-500" />
                        <span className="text-foreground">"I always quit when it gets hard"</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <Card className="overflow-hidden border border-border bg-card shadow-md hover:shadow-lg transition-all">
              <div className="bg-gradient-to-r from-amber-400 to-amber-500 text-white p-6">
                <div className="flex items-center space-x-4">
                  <Badge className="bg-white text-amber-600 text-lg font-bold px-4 py-2">4</Badge>
                ...
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div>
                    ...
                    <div className="bg-amber-50/50 p-4 rounded-lg border-l-4 border-amber-300">
                      <p className="text-sm font-semibold text-amber-700">Hidden Resource:</p>
                      <p className="text-sm text-amber-600">That friend who's already done what you're trying to do. Ask them how.</p>
                    </div>
                  </div>
                  <div className="bg-amber-50/30 p-6 rounded-xl border border-amber-200/50">
                    <h4 className="font-bold text-foreground mb-4">Your Arsenal:</h4>
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      <div className="flex items-center space-x-2">
                        <CheckCircle2 className="w-4 h-4 text-emerald-500" />
                        <span className="text-foreground">Time slots</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <CheckCircle2 className="w-4 h-4 text-emerald-500" />
                      ...
                      <div className="flex items-center space-x-2">
                        <CheckCircle2 className="w-4 h-4 text-emerald-500" />
                        <span className="text-foreground">Tools & Apps</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <CheckCircle2 className="w-4 h-4 text-emerald-500" />
            ...
            <Card className="overflow-hidden border border-border bg-card shadow-md hover:shadow-lg transition-all">
              <div className="bg-gradient-to-r from-purple-400 to-purple-500 text-white p-6">
                <div className="flex items-center space-x-4">
                  <Badge className="bg-white text-purple-500 text-lg font-bold px-4 py-2">5</Badge>
              ...
              <CardContent className="p-8">
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div>
                    ...
                    <div className="bg-purple-50/50 p-4 rounded-lg border-l-4 border-purple-300">
                      <p className="text-sm font-semibold text-purple-700">The 2-Minute Rule:</p>
                      <p className="text-sm text-purple-600">Start with actions that take less than 2 minutes. Build the habit first, then scale up.</p>
                    </div>
                  </div>
                  <div className="bg-purple-50/30 p-6 rounded-xl border border-purple-200/50">
                    <h4 className="font-bold text-foreground mb-4">Planning Hierarchy:</h4>
                    <div className="space-y-3">
                      <div className="flex items-center space-x-3">
                        <div className="w-3 h-3 bg-purple-500 rounded-full"></div>
                        <span className="text-sm font-semibold text-foreground">Big Goal</span>
                      </div>
                      ...
                      <div className="flex items-center space-x-3 ml-12">
                        ...
                        <span className="text-xs text-foreground">Weekly actions</span>
                      </div>
                      <div className="flex items-center space-x-3 ml-16">
                        <div className="w-1 h-1 bg-purple-200 rounded-full"></div>
                        <span className="text-xs text-muted-foreground">Daily habits</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <CardContent className="p-8">
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div>
                    ...
                    <div className="bg-orange-50/50 p-4 rounded-lg border-l-4 border-orange-300">
                      <p className="text-sm font-semibold text-orange-700">Action Beats Perfection:</p>
                      <p className="text-sm text-orange-600">A mediocre plan executed consistently beats a perfect plan that never gets started.</p>
                    </div>
                  </div>
                  <div className="bg-orange-50/30 p-6 rounded-xl text-center border border-orange-200/50">
                    <Flame className="w-16 h-16 text-orange-500 mx-auto mb-4" />
                    <h4 className="font-bold text-foreground mb-2">The Action Formula</h4>
            ...
            {/* Step 7 */}
            <Card className="overflow-hidden border border-border bg-card shadow-md hover:shadow-lg transition-all">
              <div className="bg-gradient-to-r from-indigo-400 to-indigo-500 text-white p-6">
                <div className="flex items-center space-x-4">
                  <Badge className="bg-white text-indigo-500 text-lg font-bold px-4 py-2">7</Badge>
              ...
              <CardContent className="p-8">
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div>
                    ...
                    <div className="bg-indigo-50/50 p-4 rounded-lg border-l-4 border-indigo-300">
                      <p className="text-sm font-semibold text-indigo-700">The WHY Question:</p>
                      <p className="text-sm text-indigo-600">Ask "why" five times in a row to get to your real motivation.</p>
                    </div>
                  </div>
                  <div className="bg-indigo-50/30 p-6 rounded-xl border border-indigo-200/50">
                    <h4 className="font-bold text-foreground mb-4">Finding Your WHY:</h4>
                    <div className="space-y-3 text-sm">
                      <div className="flex items-start space-x-3">
                        <Heart className="w-4 h-4 text-indigo-500 mt-1" />
                        <span className="text-foreground">What will this goal do for the people you love?</span>
                      </div>
                      <div className="flex items-start space-x-3">
                        <Trophy className="w-4 h-4 text-indigo-500 mt-1" />
                        <span className="text-foreground">How will you feel when you achieve this?</span>
                      </div>
                      <div className="flex items-start space-x-3">
                        <XCircle className="w-4 h-4 text-indigo-500 mt-1" />
                        <span className="text-foreground">What happens if you don't follow through?</span>
                      </div>
                    </div>
                  </div>
                </div>
